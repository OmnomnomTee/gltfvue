...
const body_map = textureLoader.load('/textures/body_emissive.png')
body_map.flipY = false
materials.body.map = body_map
materials.wheels_left.color.setRGB(1, 1, 1)
const wheels_left_map = textureLoader.load('/textures/wheels_left_emissive.png')
wheels_left_map.flipY = false
materials.wheels_left.map = wheels_left_map
materials.wheels_right.color.setRGB(1, 1, 1)
const wheels_right_map = textureLoader.load('/textures/wheels_right_emissive.png')
